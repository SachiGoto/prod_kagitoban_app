...
class Schedule extends amplify_core.Model {
  ...
  const Schedule._internal({required this.id, required yearMonth, createdAt, updatedAt}): _yearMonth = yearMonth, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Schedule({String? id, required String yearMonth}) {
  ...
  Schedule copyWith({String? yearMonth}) {
    return Schedule._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'yearMonth': _yearMonth, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
